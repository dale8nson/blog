...
export default async function Page() {
  ...
  return (
    ...
    <>
      ...
      <main className="w-11/12 min-h-[24.4vw] md:w-2/3 flex flex-col justify-start items-start content-evenly gap-5 md:columns-2 border-black border-solid border-y-[1.5px] py-4" >
